      ...
      <View style={[styles.header, { paddingTop: topPad + 16, borderBottomColor: colors.border }]}>
        <View style={styles.headerTitleRow}>
          ...
          <Text style={[styles.headerTitle, { color: colors.foreground }]}>
            {mainTab === "grupos" ? "Grupos" : "Partidos"}
          </Text>
        </View>
        ...
        <View style={[styles.mainTabRow, { borderColor: colors.border }]}>
          {([
            { key: "resultados" as MainTab, label: "Partidos",   icon: "flag"   },
...
const styles = StyleSheet.create({
  ...
  mainTabText: { fontSize: ms(11), fontFamily: "Inter_600SemiBold" },
  ...
  tabText: { fontSize: ms(10), fontFamily: "Inter_600SemiBold" },
  ...
  badgeTxt: { fontSize: ms(9), fontFamily: "Inter_600SemiBold" },
  ...
  flagPh: { width: sc(44), height: sc(30), borderRadius: 4, alignItems: "center", justifyContent: "center" },
  flagPhTxt: { fontSize: ms(9), fontFamily: "Inter_700Bold" },
  teamName: { fontSize: ms(12), fontFamily: "Inter_600SemiBold", textAlign: "center" },
  centerCol: { alignItems: "center", justifyContent: "center", minWidth: sc(64), gap: 2 },
  scoreText: { fontSize: ms(20), fontFamily: "Inter_700Bold" },
  ...
  dateText: { fontSize: ms(11), fontFamily: "Inter_400Regular" },
  empty: { alignItems: "center", paddingTop: 60, gap: 10 },
  emptyText: { fontSize: ms(14), fontFamily: "Inter_500Medium" },
  ...
  groupTabText: { fontSize: ms(13), fontFamily: "Inter_700Bold" },
  groupHeader: { flexDirection: "row", alignItems: "baseline", justifyContent: "space-between" },
  groupTitle: { fontSize: ms(17), fontFamily: "Inter_700Bold" },
  groupSub:   { fontSize: ms(12), fontFamily: "Inter_400Regular" },
  groupEmpty: { padding: 24, alignItems: "center" },
  groupEmptyTxt: { fontSize: ms(13), fontFamily: "Inter_400Regular" },
  ...
  colHeader: { fontFamily: "Inter_600SemiBold", fontSize: ms(9), textTransform: "uppercase" },
  colPos: { width: sc(20), textAlign: "center", fontSize: ms(12) },
  colFlag: { width: sc(30), alignItems: "center", marginRight: 6 },
  colTeam: { flex: 1, fontSize: ms(12), marginRight: 4 },
  colStat: { width: sc(26), textAlign: "center", fontSize: ms(11), fontFamily: "Inter_400Regular" },
  standingFlag: { width: sc(24), height: sc(16), borderRadius: 3 },
  standingFlagPh: { width: sc(24), height: sc(16), borderRadius: 3, alignItems: "center", justifyContent: "center" },

  legend: { gap: 6 },
  legendItem: { flexDirection: "row", alignItems: "center", gap: 8 },
  legendDot: { width: 8, height: 8, borderRadius: 4 },
  legendTxt: { fontSize: ms(12), fontFamily: "Inter_400Regular" },

  matchesSectionHeader: { flexDirection: "row", alignItems: "center", gap: 8, paddingTop: 4 },
  matchesSectionTitle: { fontSize: ms(15), fontFamily: "Inter_700Bold" },

  // Prediction stats badges
  statBadgeRow: { flexDirection: "row", gap: 5 },
  statBadge: {
    flexDirection: "row", alignItems: "center", gap: 4,
    borderRadius: 4, borderWidth: 1,
    paddingHorizontal: 7, paddingVertical: 3,
  },
  statBadgeTxt: { fontSize: ms(11), fontFamily: "Inter_700Bold" },
  ...
  modalTitle: { fontSize: ms(16), fontFamily: "Inter_700Bold" },
  modalBody: {
    flexDirection: "row", alignItems: "center", justifyContent: "space-evenly",
    paddingHorizontal: 20, paddingVertical: 24,
  },
  teamCol: { flex: 1, alignItems: "center", gap: 10 },
  modalFlag: { width: sc(72), height: sc(48), borderRadius: 6 },
  teamNameModal: {
    fontSize: ms(13), fontFamily: "Inter_600SemiBold",
    textAlign: "center", maxWidth: sc(110),
  },
  modalVs: { fontSize: ms(18), fontFamily: "Inter_700Bold", marginHorizontal: 8 },
  modalActions: {
  ...
  revertBtnTxt: { fontSize: ms(13), fontFamily: "Inter_600SemiBold" },
  saveBtn: {
    flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center",
    gap: 8, borderRadius: 12, paddingVertical: 14,
  },
  saveBtnTxt: { fontSize: ms(15), fontFamily: "Inter_700Bold" },

  // Stepper
  stepper: { flexDirection: "row", alignItems: "center", gap: 12 },
  stepBtn: {
    width: sc(36), height: sc(36), borderRadius: 10, borderWidth: 1,
    alignItems: "center", justifyContent: "center",
  },
  stepVal: { fontSize: ms(28), fontFamily: "Inter_700Bold", minWidth: sc(36), textAlign: "center" },
});
