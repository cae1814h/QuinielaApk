...
const styles = StyleSheet.create({
  ...
  title: { fontSize: ms(20), fontFamily: "Inter_700Bold" },
  ...
  sumValue: { fontSize: ms(16), fontFamily: "Inter_700Bold" },
  sumLabel: { fontSize: ms(10), fontFamily: "Inter_500Medium", textAlign: "center" },
  ...
  colLbl: { fontSize: ms(10), fontFamily: "Inter_600SemiBold", textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  rankNum: { fontSize: ms(13), fontFamily: "Inter_700Bold" },
  nameRow: { flexDirection: "row", alignItems: "center", gap: 6 },
  name: { fontSize: ms(14), fontFamily: "Inter_600SemiBold", flexShrink: 1 },
  subStats: { fontSize: ms(11), fontFamily: "Inter_400Regular", marginTop: 1 },
  meBadge: { borderRadius: 4, borderWidth: 1, paddingHorizontal: 5, paddingVertical: 1 },
  meTxt: { fontSize: ms(9), fontFamily: "Inter_700Bold" },
  ...
  prizeTxt: { fontSize: ms(10), fontFamily: "Inter_700Bold" },

  // Points badge
  ptsBadge: {
    borderRadius: 8, borderWidth: 1,
    paddingHorizontal: 10, paddingVertical: 5,
    alignItems: "center", minWidth: sc(56),
  },
  ptsNum: { fontSize: ms(16), fontFamily: "Inter_700Bold", lineHeight: ms(19) },
  ptsWord: { fontSize: ms(9), fontFamily: "Inter_600SemiBold", marginTop: 0 },
  ...
  sheetName: { fontSize: ms(18), fontFamily: "Inter_700Bold" },
  sheetRankTxt: { fontSize: ms(13), fontFamily: "Inter_400Regular", marginTop: 2 },
  sheetPtsPill: {
    borderRadius: 10, borderWidth: 1,
    paddingHorizontal: 12, paddingVertical: 6,
    alignItems: "center",
  },
  sheetPtsNum: { fontSize: ms(20), fontFamily: "Inter_700Bold", lineHeight: ms(24) },
  sheetPtsLabel: { fontSize: ms(10), fontFamily: "Inter_600SemiBold" },
  statRow: {
    flexDirection: "row", alignItems: "center", justifyContent: "space-between",
    paddingVertical: 13, borderBottomWidth: 1,
  },
  statLeft: { flexDirection: "row", alignItems: "center", gap: 10 },
  statLabel: { fontSize: ms(14), fontFamily: "Inter_400Regular" },
  statValue: { fontSize: ms(16), fontFamily: "Inter_700Bold" },
  closeBtn: {
    borderRadius: 10, borderWidth: 1, paddingVertical: 14, alignItems: "center",
  },
  closeTxt: { fontSize: ms(15), fontFamily: "Inter_600SemiBold" },
});
