...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: ms(13), fontFamily: "Inter_500Medium", marginBottom: 2 },
  appTitle: { fontSize: ms(18), fontFamily: "Inter_700Bold" },
  avatarBtn: { width: sc(50), height: sc(50), borderRadius: sc(25), borderWidth: 2, overflow: "hidden" },
  avatarGrad: { flex: 1, alignItems: "center", justifyContent: "center" },
  avatarTxt: { fontSize: ms(17), fontFamily: "Inter_700Bold" },
  statsRow: { flexDirection: "row", gap: 8 },
  statCard: { flex: 1, borderRadius: 4, borderWidth: 1, padding: 8, alignItems: "center", gap: 3 },
  statValue: { fontSize: ms(22), fontFamily: "Inter_700Bold" },
  statLabel: { fontSize: ms(9), fontFamily: "Inter_500Medium" },
  ...
  prizePot: {
    fontSize: ms(36), fontFamily: "Inter_700Bold", color: GOLD,
    lineHeight: ms(42),
  },
  prizeSubtitle: {
    fontSize: ms(11), fontFamily: "Inter_400Regular", color: "rgba(251,191,36,0.6)",
  },
  prizeDivider: { height: 1 },
  prizeDist: { gap: 8 },
  prizeDistLabel: {
    fontSize: ms(10), fontFamily: "Inter_600SemiBold",
  ...
  prizeDistPlace: { fontSize: ms(16), fontFamily: "Inter_700Bold" },
  prizeDistAmount: { fontSize: ms(12), fontFamily: "Inter_600SemiBold" },
  prizeDistPct: { fontSize: ms(10), fontFamily: "Inter_400Regular", color: "rgba(251,191,36,0.5)" },

  // Today's matches
  section: { padding: 12, paddingTop: 10, gap: 5 },
  sectionHeader: { flexDirection: "row", alignItems: "center", gap: 8 },
  sectionTitle: { fontSize: ms(15), fontFamily: "Inter_700Bold", flex: 1 },
  emptyCard: {
    borderRadius: 12, borderWidth: 1, padding: 28, alignItems: "center", gap: 10,
  },
  emptyTxt: { fontSize: ms(14), fontFamily: "Inter_500Medium" },
  emptyLink: { fontSize: ms(13), fontFamily: "Inter_600SemiBold", marginTop: 4 },
});
